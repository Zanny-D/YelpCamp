    ...
    helmet.contentSecurityPolicy({
        directives: {
            ...
            imgSrc: [
                ...
                "blob:",
                "data:",
                "https://res.cloudinary.com/drbqnahql/", //SHOULD MATCH YOUR CLOUDINARY ACCOUNT! 
...
// const port = process.env.PORT || 3000; // <----- IF WE USED HEROKU
const port = 3000; // WE ARE USING RENDER
app.listen(port, () => {
